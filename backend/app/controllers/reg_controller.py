...
class RegController:
    def set_doc_reg(document_id, username):
        try:
            ...
            if not register:
                return ApiResponse.error(message="No se ha podido agregar a tu librería", status_code=404)
            return ApiResponse.success(message="Documentos de carrito añadido a librería")
